...
sudo_users = {SUDO,1804133252,1885313077,968613145,1372188096,1227722692}   
...
if text == "غنيلي فيديو" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(4,74); 
local Text ='تم اختيار هذه الاغنيه لك❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
} 
...
if text == "احاديث" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(4,74); 
local Text ='تم اختيار هذا الحديث لك❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
} 
